...
app.registerExtension({
	name: "Gemini.GeminiImageGenADV", // Unique name for the extension
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		// Check if this is the correct node we want to modify
		if (nodeData.name === "GeminiImageGenADV") {
			...
			nodeType.prototype.onNodeCreated = function () {
				...
				this.addWidget("button", "Update inputs", null, () => {
					...
					if (!inputCountWidget) {
						console.error("GeminiImageGenADV: 'inputcount' widget not found on this node!");
						return;
					}
